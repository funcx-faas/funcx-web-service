...
class TestAuth(AppTestBase):
    def test_callback_no_code(self, mocker):
        ...
        mock_client.oauth2_get_authorize_url = mocker.Mock(
            return_value="http://secure.org"
        )
        mocker.patch(
            "funcx_web_service.routes.auth.get_auth_client", return_value=mock_client
        )
    ...
    def test_callback_error(self, mocker):
        ...
        mocker.patch(
            "funcx_web_service.routes.auth.url_for", return_value="http://funcx.home"
        )
        ...
        assert (
            ...
            == 'You could not be logged into funcX: "bad stuff"'
        )
    ...
    def test_callback_with_code(self, mocker):
        ...
        mock_tokens.decode_id_token = mocker.Mock(
            return_value={
        ...
        mock_client.oauth2_exchange_code_for_tokens = mocker.Mock(
