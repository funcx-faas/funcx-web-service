...
from funcx_web_service.authentication.auth import FUNCX_SCOPE, get_auth_client
...
def callback():
    ...
    if "error" in request.args:
        flash(
            "You could not be logged into funcX: "
    ...
    requested_scopes = [
        app.config.get("FUNCX_SCOPE", FUNCX_SCOPE),
        "profile",
    ...
    client.oauth2_start_flow(
        redirect_uri, requested_scopes=requested_scopes, refresh_tokens=False
    )
